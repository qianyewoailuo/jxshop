...
<body>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="<?php echo U('/');?>"><img src="/Public/Home/images/logo.png" alt="京西商城"></a></h2>
			<div class="flow fr">
				<ul>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="col3">￥<span><?php echo ($vo["goods"]["shop_price"]); ?>.00</span></td>
					<td class="col4"> 
					...
					<td class="col5">￥<span><?php echo ($vo['goods_count']*$vo['goods']['shop_price']); ?>.00</span></td>
					<td class="col6"><a href="<?php echo U('del','goods_id='.$vo['goods_id'].'&goods_attr_ids='.$vo['goods_attr_ids']);?>" onclick="return confirm('确认删除吗?')">删除</a></td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
			<tfoot>
				<tr>
					<td colspan="6">购物金额总计： <strong>￥ <span id="total"><?php echo ($total["price"]); ?>.00</span></strong></td>
				</tr>
			</tfoot>
		</table>
...
<script type="text/javascript">
	...
	$('.add_num').click(function(){
		...
		//发送ajax
		//因为+在js中有拼接字符串意义且当前数量是浮点型所以要转为整形.
