			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					...
					<?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><img src="/<?php echo ($vo["goods_thumb"]); ?>" alt="<?php echo ($vo["goods_name"]); ?>" title="<?php echo ($vo["goods_name"]); ?>" /></a></dt>
								<dd><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
...
<?php if(is_array($floor)): $i = 0; $__LIST__ = $floor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
					<?php if(is_array($vo["children"])): $i = 0; $__LIST__ = $vo["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Category/index','id='.$v['id']);?>"><b>.</b><?php echo ($v["cname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
			...
			<div class="goodslist fl">
				<h2>
				<?php if(is_array($vo["rec_children"])): $keys = 0; $__LIST__ = $vo["rec_children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($keys % 2 );++$keys;?><span <?php if(($keys) == "1"): ?>class="on"<?php endif; ?> ><?php echo ($v["cname"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
				</h2>
				<div class="goodslist_wrap">
				<?php if(is_array($vo["rec_children"])): $keys = 0; $__LIST__ = $vo["rec_children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($keys % 2 );++$keys;?><div <?php if(($keys) != "1"): ?>class="none"<?php endif; ?>>
						<ul>
						<?php if(is_array($v2["goods"])): $i = 0; $__LIST__ = $v2["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v3): $mod = ($i % 2 );++$i;?><li>
								<dl>
									<dt><a href="<?php echo U('Goods/index','goods_id='.$v3['id']);?>"><img src="/<?php echo ($v3["goods_thumb"]); ?>" alt="没有图" /></a></dt>
									<dd><a href=""><?php echo ($v3["goods_name"]); ?></a></dd>
