	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="order_hd">
				...
				<dl>
					<dt>快递公司：</dt>
					<dd><a href="#"><?php echo ($data["result"]["company"]); ?></a></dd>
                </dl>
                
                <dl>
                    <dt>快递单号：</dt>
                    <dd><a href="#"><?php echo ($data["result"]["no"]); ?></a></dd>
                </dl>

                <dl>
                    <dt>快递状态：</dt>
                    <dd><a href="#"><?php if(($data["result"]["status"]) == "1"): ?>已发货<?php else: ?>待发货<?php endif; ?></a></dd>
                </dl>
			</div>
