			...
			<div class="order_bd mt10">
				<table class="orders">
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>￥<?php echo ($vo["total_price"]); ?> 货到付款</td>
							<td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?><br><?php echo date('Y-m-d H:i:s',$vo['addtime']);?></td>
							
							<td><?php if(($vo["pay_status"]) == "0"): ?>待支付:<br><a href="<?php echo U('Order/pay','order_id='.$vo['id']);?>">继续支付</a><?php else: ?>已完成<?php endif; ?></td>
							<td><?php if(($vo["order_status"]) == "2"): ?>已发货:<br><a href="<?php echo U('express','order_id='.$vo['id']);?>">查看快递信息</a><?php else: ?><a href="">查看</a><?php endif; ?>  | <a href="">删除</a></td>
