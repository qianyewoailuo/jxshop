	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				<h2><a href="<?php echo myU('reset','');?>">重置筛选条件</a> <strong>商品筛选</strong></h2>
				...
				<?php if(is_array($data["attrwhere"])): $k = 0; $__LIST__ = array_slice($data["attrwhere"],0,3,true);if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><dl <?php if(($k) == "3"): ?>class="last"<?php endif; ?> >
						<dt><?php echo ($vo["0"]["attr_name"]); ?>：</dt>
						<dd class="cur"><a href="<?php echo myU('attr','');?>">不限</a></dd>
					<?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd <?php if(in_array(($v["attr_values"]), is_array($_GET['attr'])?$_GET['attr']:explode(',',$_GET['attr']))): ?>class="cur"<?php endif; ?> ><a href="<?php echo myU('attr',$v['attr_values']);?>" <?php if(($_GET['attr']) == $attr_values): ?>class="cur"<?php endif; ?>><?php echo ($v["attr_values"]); ?></a></dd><?php endforeach; endif; else: echo "暂时没有数据" ;endif; ?>
			...
			<div class="sort mt10">
				<dl>
					...
					<dd <?php if(($_GET['sort']) == "total_comment"): ?>class="cur"<?php endif; ?>><a href="<?php echo myU('sort','total_comment');?>">评论数</a></dd>
			...
			<div class="goodslist mt10">
				...
				<?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<dl>
							...
							<dd><a href="<?php echo U('Goods/index','goods_id='.$vo['id']);?>"><em>已有<?php echo ($vo["total_comment"]); ?>人评价</em></a></dt>
						</dl>
