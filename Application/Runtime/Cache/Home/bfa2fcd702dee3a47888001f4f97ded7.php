...
<body>
	...
	<div class="login w990 bc mt10 regist">
		<div class="login_hd">
			<h2>用户注册|<a href="<?php echo U('User/registbyemail');?>" style="color:red">邮箱注册</a></h2>
			<b></b>
		</div>
		<div class="login_bd">
				...
				<form action="" method="post">
					<ul>
						...
						<li>
							...
							<input type="password" class="txt" name="is_password" />
							<p> <span>请再次输入密码</p>
						</li>
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="checkcode" id="ischeckcode" />
						...
						<li class="checkcode">
							...
							<input type="button" id="sendcode" value="点击获取" style="height:32px" />
						</li>
						<!-- 短信注册验证 -->
						<li>
							<label for="">&nbsp;</label>
...
<script type="text/javascript">
	...
	// ajax插件jqueryForm验证提交注册
	$('form').submit(function(){
		//具体实现使用jqueryForm的方式提交
		$(this).ajaxSubmit({
			url:"<?php echo U('regist');?>",	//指定表单提交的地址
			type:'post',			//指定表单提交的方式
			dataType:'json',		//指定数据交互的方式
