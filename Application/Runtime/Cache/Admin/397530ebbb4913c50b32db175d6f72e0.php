    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <!-- 使用eq判定是否选中推荐 -->
                    <input type="radio" name="isrec" value="1" <?php if(($info["isrec"]) == "1"): ?>checked<?php endif; ?>  /> 是 
                    <input type="radio" name="isrec" value="0" <?php if(($info["isrec"]) == "0"): ?>checked<?php endif; ?> /> 否
                </td>
            </tr>
