...
<h1>
    ...
    <span class="action-span"><a href="<?php echo U('add');?>">添加商品类型</a></span>
...
<div class="list-div" id="listDiv">
    ...
    <?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center">
                <!-- <a href="<?php echo U('disfetch','type_id='.$vo['id']);?>" target="_blank" title="查看权限"><img src="/Public/Admin/Images/icon_view.gif" width="16" height="16" border="0" />查权限</a> -->
                <a href="<?php echo U('edit','type_id='.$vo['id']);?>" title="编辑"><img src="/Public/Admin/Images/icon_edit.gif" width="16" height="16" border="0" /></a>
                <a href="<?php echo U('del','type_id='.$vo['id']);?>" title="回收站" onclick="return confirm('确定放入回收站吗？')"><img src="/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" /></a>
            </td>
