...
#container{width: 800px;height: 400px;margin:20px auto;text-align: center;}
...
.system-message .success,.system-message .error{ line-height: 1.8em; font-size: 32px }
...
<body>
<div class="system-message" id="container">
<h2>抱歉,出错了...</h2>
...
<div>
    ...
    <!-- <a id="href" id="btn-now" href="<?php echo(U('login')); ?>">重新登录</a>  -->
</div>
</div>
