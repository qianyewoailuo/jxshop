...
<body>
<div id="header-div">
    <div id="logo-div" style="background-color:#000000;">
    ...
    <div id="submenu-div">
        ...
        <div id="send_info">
            <a href="<?php echo U('Role/superAdminUpdate');?>" target="main-frame" class="fix-submenu">superAdminUpdate</a>
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="index.html" target="main-frame">起始页</a></li>
